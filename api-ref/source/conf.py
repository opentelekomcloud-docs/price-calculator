...
otcdocs_repo_name = 'opentelekomcloud-docs/price-calculator'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/price-calculator/api-ref/'
otcdocs_doc_title = 'API Reference'
otcdocs_doc_type = 'api-ref'
otcdocs_service_category = 'other'
otcdocs_service_title = 'Price Calculator'
otcdocs_service_type = 'pc'
...
html_title = "Price Calculator - API Reference"
